  ...
  <el-row :gutter="10">
    <el-col :span="8">
      <el-card style="height: calc(100vh - 125px)">
        ...
        <el-table v-loading="loading" :data="cacheNames" :height="tableHeight" highlight-current-row style="width: 100%" @rowClick="getCacheKeys">
          ...
          <el-table-column label="操作" width="60" align="center" :min-width="140">
    ...
    <el-col :span="8">
      <el-card style="height: calc(100vh - 125px)">
        ...
        <el-table v-loading="subLoading" :data="cacheKeys" :height="tableHeight" highlight-current-row style="width: 100%" @rowClick="handleCacheValue">
          <el-table-column label="序号" width="60" type="index"></el-table-column>
...
async function getCacheKeys(row?: any) {
  ...
  const res: any = await listCacheKey(cacheName)
