<template>
  <!-- 导入表 -->
  <el-dialog v-model="visible" title="导入表" width="800px" top="5vh" append-to-body draggable>
    ...
    <el-row>
      <el-table ref="table" :data="dbTableList" height="260px" @rowClick="clickRow" @selectionChange="handleSelectionChange">
